        ...
        switch (request.getParameter("op")) {
            ...
            case "update":
                try {
                   ...
                   //Metodo para convertir a fecha con beansUtils 
                   CalendarConverter cc = new CalendarConverter();
                   //Pattern para indicarle el formato de fecha que nos llegara
                   cc.setPattern("yyyy-MM-dd'T'HH:mm");
                   ConvertUtils.register(cc, Calendar.class);
                   //rellenamos con beans Utils
